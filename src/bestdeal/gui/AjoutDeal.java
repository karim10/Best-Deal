...
public class AjoutDeal extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        d.setNomDeal(jTextField1.getText());
        d.setDescDeal(jTextField2.getText());
        d.setDateDebut(jTextField3.getText());
        d.setDateFin(jTextField4.getText());
        d.setPrix(Float.parseFloat(jTextField5.getText()));
        d.setRemise(Float.parseFloat(jTextField6.getText()));
        d.setQuantite(Integer.parseInt(jTextField7.getText()));
        dAO.insertDeal(d);
